...
<template>
  <div class="border rounded  border-gray-250  bg-white p-5 mb-8" style="width: 250px;">
    ...
    <button type="button"
      class="text-base leading-5 border rounded border-primary-blue bg-white hover:bg-primary-blue text-primary-blue hover:text-white w-full py-2.5 mb-4">發表新話題</button>
