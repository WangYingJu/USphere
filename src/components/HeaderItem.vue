  ...
  <header class="justify-center bg-white border border-gray-250 py-5">
    <div class="container mx-auto max-w-screen-lg flex justify-between items-center">
      ...
      <form
        ...
        style="width: 520px;">
        <input type="search" action="/search" method="get" name="search-bar" id="search-bar"
          placeholder="尋找話題？試著輸入......寶可夢！" class="w-full bg-gray-input-bg placeholder-gray-300">
        <button type="button">
          <svg class="h-auto w-4 text-gray-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
